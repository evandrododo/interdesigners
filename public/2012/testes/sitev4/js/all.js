	...
	$('#nav > ul > li').click(function(e){
		...
		$(".content-container").load( url + " .content-container", function(){
			...
			if (url === 'inscricoes.html') {
				$('form[name=formapoio]').unbind('submit');
				$('form[name=formapoio]').submit(function () {
					submitapoio();
					return false;
				});
				$('form[name=formoficina]').unbind('submit');
				$('form[name=formoficina]').submit(function () {
					submitOficina();
					return false;
				});
				$('form[name=formencontrista]').unbind('submit');
				$('form[name=formencontrista]').submit(function () {
					submitencontrista();
					return false;
				});
				$('form[name=formbazar]').unbind('submit');
				$('form[name=formbazar]').submit(function () {
					submitBazar();
					return false;
				});
				$('form[name=formexpo]').unbind('submit');
				$('form[name=formexpo]').submit(function () {
					submitExpo();
					return false;
				});
				formResize();
