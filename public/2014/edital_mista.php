...
<input name='link' value='nome completo do co-autor'/>
<select name='pg1'>
...
<textarea name='descricao'>descreva sua oficina, suas intenções, as áreas que serão misturadas, os pontos em comum e os conhecimentos necessários aos participantes</textarea>
