...
if ($_FILES['arquivo']['error'] != 0) {
	...
	if (array_search($extensao, $_UP['extensoes']) === false) {
		echo "envie um arquivo na extensão <strong>.doc</strong> seguindo <a href='uploads/artigos/modelo.doc' target='_blank'>este template</a>";
	}

	// Faz a verificação do tamanho do arquivo
	else if ($_UP['tamanho'] < $_FILES['arquivo']['size']) {
		echo "O arquivo enviado é muito grande, envie arquivos de até <strong>10mb</strong>.";
	}
...
<form id='simposio_form' <?=$oculta?> action='simposio_arquivo.php' method='post' enctype="multipart/form-data">
