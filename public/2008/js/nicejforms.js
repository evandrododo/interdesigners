...
jQuery.NiceJForms = {
	...
	preloadImages: function()
	{
		...
		jQuery.NiceJForms.options.imagesPath + "blank.gif", jQuery.NiceJForms.options.imagesPath + "blank.gif", 
		jQuery.NiceJForms.options.imagesPath + "blank.gif", jQuery.NiceJForms.options.imagesPath + "blank.gif", jQuery.NiceJForms.options.imagesPath + "blank.gif", jQuery.NiceJForms.options.imagesPath + "blank.gif");
	},
	...
	getElements: function(elm)
	{
		...
		jQuery.NiceJForms.buttons = $('input[@type=button]', el).add($('input[@type=button]', el));
		jQuery.NiceJForms.buttons = $('input[@type=button]', el).add($('input[@type=submit]', el));
...
replaceCheckboxes: function () 
	...
	checkCheckboxes: function(who, action)
	{
		...
		if(action == false) {$(what).removeClass().addClass("checkboxAreaChecked");}
		if(action == true) {$(what).removeClass().addClass("checkboxArea");}
	},
