...
jQuery.NiceJForms = {
	options : {
		...
		imagesPath               : "http://playstop.net/interdesigners/img/"
		// other options here
	},
	...
	{
		jQuery.NiceJForms.preloads = $.preloadImages(jQuery.NiceJForms.options.imagesPath + "button_left_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "button_right_xon_blog.gif", 
		jQuery.NiceJForms.options.imagesPath + "input_left_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "input_right_xon_blog.gif",
		jQuery.NiceJForms.options.imagesPath + "txtarea_bl_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "txtarea_br_xon_blog.gif", 
		jQuery.NiceJForms.options.imagesPath + "txtarea_cntr_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "txtarea_l_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "txtarea_tl_xon_blog.gif", jQuery.NiceJForms.options.imagesPath + "txtarea_tr_xon_blog.gif");
	},
...
replaceCheckboxes: function () 
	...
	replaceTexts: function() {
		jQuery.NiceJForms.texts.each(function(q){
			...
			jQuery(txtLeft)
				.attr({src:jQuery.NiceJForms.options.imagesPath + "input_left_blog.gif"})
				.addClass("inputCorner");
			
			var txtRight = new Image();
			jQuery(txtRight)
				.attr({src:jQuery.NiceJForms.options.imagesPath + "input_right_blog.gif"})
				.addClass("inputCorner");
			
			$(jQuery.NiceJForms.texts[q]).before(txtLeft).after(txtRight).addClass("textinput");
			
			//create hovers
			$(jQuery.NiceJForms.texts[q]).focus(function(){$(this).addClass("textinputHovered");$(this).prev().attr('src', jQuery.NiceJForms.options.imagesPath + "input_left_xon_blog.gif");$(this).next().attr('src', jQuery.NiceJForms.options.imagesPath + "input_right_xon_blog.gif");});
			
			$(jQuery.NiceJForms.texts[q]).blur(function() {$(this).removeClass().addClass("textinput");$(this).prev().attr('src', jQuery.NiceJForms.options.imagesPath + "input_left_blog.gif");$(this).next().attr('src', jQuery.NiceJForms.options.imagesPath + "input_right_blog.gif");});
		});
	},
	...
	replaceTextareas: function() {
		jQuery.NiceJForms.textareas.each(function(q){
			...
			$(this).css({width: $(this).attr("cols") * 8 + 'px', height: $(this).attr("rows") * 10 + 'px'});
			//create divs
			...
			jQuery(topLeft).attr({src: jQuery.NiceJForms.options.imagesPath + 'txtarea_tl_blog.gif'}).addClass("txt_corner");
			...
			jQuery(bottomLeft).attr({src: jQuery.NiceJForms.options.imagesPath + 'txtarea_bl_blog.gif'}).addClass('txt_corner');
	...
	buttonHovers: function() {
		jQuery.NiceJForms.buttons.each(function(i){
			...
			jQuery(buttonLeft).attr({src: jQuery.NiceJForms.options.imagesPath + "button_left_blog.gif"}).addClass("buttonImg");
			
			$(this).before(buttonLeft);
			
			var buttonRight = document.createElement('img');
			jQuery(buttonRight).attr({src: jQuery.NiceJForms.options.imagesPath + "button_right_blog.gif"}).addClass("buttonImg");
			
			if($(this).next()) {$(this).after(buttonRight)}
			else {$(this).parent().append(buttonRight)};
			
			$(this).hover(
				function(){$(this).attr("class", $(this).attr("class") + "Hovered"); $(this).prev().attr("src", jQuery.NiceJForms.options.imagesPath + "button_left_xon_blog.gif"); $(this).next().attr("src", jQuery.NiceJForms.options.imagesPath + "button_right_xon_blog.gif")},
				function(){$(this).attr("class", $(this).attr("class").replace(/Hovered/g, "")); $(this).prev().attr("src", jQuery.NiceJForms.options.imagesPath + "button_left_blog.gif"); $(this).next().attr("src", jQuery.NiceJForms.options.imagesPath + "button_right_blog.gif")}
			);
		});
	}
}
